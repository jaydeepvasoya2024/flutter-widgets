...
abstract class ChartSeries<T, D> extends SlottedMultiChildRenderObjectWidget<SeriesSlot, RenderObject> {
  ...
  @mustCallSuper
  @override
  void updateRenderObject(BuildContext context, ChartSeriesRenderer<T, D> renderObject) {
    renderObject
      ..xValueMapper = xValueMapper
      ..dataSource = dataSource
      ..pointColorMapper = pointColorMapper
...
abstract class ChartSeriesRenderer<T, D> extends RenderBox
    with SlottedContainerRenderObjectMixin<SeriesSlot, RenderBox>, ChartAreaUpdateMixin, LegendItemProviderMixin {
  ChartSeriesRenderer() {
    _fetchMarkerImage();
  }
  ...
  RenderChartElementLayoutBuilder<T, D>? get dataLabelContainer =>
      childForSlot(SeriesSlot.dataLabel) as RenderChartElementLayoutBuilder<T, D>?;
  ...
  RenderTrendlineStack? get trendlineContainer => childForSlot(SeriesSlot.trendline) as RenderTrendlineStack?;
  ...
  ChartValueMapper<T, dynamic>? get sortFieldValueMapper => _sortFieldValueMapper;
  ...
  set selectionBehavior(SelectionBehavior? value) {
    if (_selectionBehavior != value) {
      _selectionBehavior?.selectionController?.removeListener(_handleSelectionControllerChange);
      _selectionBehavior = value;
      _effectiveSelectionBehavior = value;
      _selectionBehavior?.selectionController?.addListener(_handleSelectionControllerChange);
  ...
  SelectionBehavior? get effectiveSelectionBehavior => _effectiveSelectionBehavior;
  ...
  bool get _tooltipEnabled =>
      enableTooltip && parent != null && parent!.tooltipBehavior != null && parent!.tooltipBehavior!.enable;
  ...
  bool get _selectionEnabled => selectionBehavior != null && selectionBehavior!.enable;
  ...
  List<LegendItem>? buildLegendItems(int index) {
    if (isVisibleInLegend) {
      final LegendItem legendItem = ChartLegendItem(
        ...
        overlayMarkerType: markerSettings.isVisible ? toShapeMarkerType(markerSettings.shape) : null,
        imageProvider: legendIconType == LegendIconType.image ? parent?.legend?.image : null,
  ...
  double legendIconBorderWidth() {
    if (legendIconType == LegendIconType.horizontalLine || legendIconType == LegendIconType.verticalLine) {
      return 2;
    }
    return 1;
  }
  ...
  void handleLegendItemTapped(LegendItem item, bool isToggled) {
    if (parent != null && parent!.onLegendTapped != null) {
      ...
      final LegendTapArgs args = LegendTapArgs(legendItem.series, legendItem.seriesIndex, legendItem.pointIndex);
  ...
  void _handleLegendItemCreated(ItemRendererDetails details) {
    if (parent != null && parent!.onLegendItemRender != null) {
      ...
      if (args.legendIconType != iconType) {
        details.iconType = toLegendShapeMarkerType(args.legendIconType ?? LegendIconType.seriesType, this);
      }
  ...
  void _initAnimations() {
    ...
    double curveEnd = seriesDuration - (markerDuration + dataLabelAnimationDuration);
    _animationController ??= AnimationController(vsync: parent!.vsync!)
      ..addStatusListener(_handleAnimationStatusChange);
    _animationController!.duration = Duration(milliseconds: duration);
    _animation ??= CurvedAnimation(parent: _animationController!, curve: Interval(curveStart, curveEnd))
      ..addListener(_handleAnimationUpdate);

    final double defaultElementAnimationValue =
        (animationDuration == 0 || animationType == AnimationType.none) ? 1.0 : 0.0;
    ...
    _dataLabelAnimationController ??= AnimationController(vsync: parent!.vsync!);
  ...
  bool _canPopulateDataPoints(List<ChartValueMapper<T, num>>? yPaths, List<List<num>>? yLists) {
  ...
  void populateDataSource([
    ...
    final Function(D? value, num x) addXValue = _addXValueIntoRawAndChaoticXLists;
  ...
  void _addPointColorMapper(
      List<ChartValueMapper<T, Object>>? fPaths, List<List<Object?>>? chaoticFLists, List<List<Object?>>? fLists) {
  ...
  void _doSortingIfNeeded(List<List<num>>? chaoticYLists, List<List<num>>? yLists, List<List<Object?>>? chaoticFLists,
      List<List<Object?>>? fLists) {
    if (sortingOrder != SortingOrder.none &&
        chaoticYLists != null &&
  ...
  void _sort(List<List<num>> chaoticYLists, List<List<num>> yLists, List<List<Object?>>? chaoticFLists,
      List<List<Object?>>? fLists,
      {bool ascending = true}) {
  ...
  void _computeSortedIndexes(bool ascending) {
    ...
    do {
      ...
      for (int i = 0; i < length - 1; i++) {
        ...
        if (canSwap(_chaoticRawSortValues[nextIndex], _chaoticRawSortValues[currentIndex])) {
  ...
  void updateSegmentColor(ChartSegment segment, Color? borderColor, double borderWidth,
    ...
    if (effectiveSelectionBehavior != null &&
      ...
      if (isSelected || segment.isSelected) {
        ...
        strokeColor = effectiveSelectionBehavior!.selectedBorderColor ?? strokeColor;
        if (strokeColor != Colors.transparent) {
          strokeColor = strokeColor.withOpacity(opacity);
        }
        strokeWidth = effectiveSelectionBehavior!.selectedBorderWidth ?? strokeWidth;
      } else {
        ...
        strokeColor = effectiveSelectionBehavior!.unselectedBorderColor ?? strokeColor;
        if (strokeColor != Colors.transparent) {
          strokeColor = strokeColor.withOpacity(opacity);
        }
        strokeWidth = effectiveSelectionBehavior!.unselectedBorderWidth ?? strokeWidth;
      }
    }
  ...
  Color effectiveColor(int segmentIndex) {
    Color? pointColor;
    if (pointColorMapper != null && pointColors.isNotEmpty && pointColors.length > segmentIndex) {
  ...
  bool hitTest(BoxHitTestResult result, {required Offset position}) {
    ...
    if (dataLabelContainer != null) {
      final ChartSeriesParentData childParentData = dataLabelContainer!.parentData! as ChartSeriesParentData;
    ...
    if (trendlineContainer != null) {
      final ChartSeriesParentData childParentData = trendlineContainer!.parentData! as ChartSeriesParentData;
    ...
    final bool hasTouchCallback = onPointLongPress != null || onPointTap != null || onPointDoubleTap != null;
    bool isSeriesHit = false;
    if (isVisible() && (_tooltipEnabled || _selectionEnabled || hasTouchCallback)) {
  ...
  void handlePointerUp(PointerUpEvent details) {
    ...
    if (onPointTap != null && _interactiveSegment != null && _canInvokePointerUp) {
      final int pointIndex = dataPointIndex(localPosition, _interactiveSegment!);
      final int segPointIndex = segmentPointIndex(localPosition, _interactiveSegment!);
  ...
  void handlePointerHover(PointerHoverEvent details) {
    ...
    if (parent != null && _interactiveSegment != null) {
      ...
      final bool hasTooltip = _tooltipEnabled && parent!.tooltipBehavior!.activationMode == ActivationMode.singleTap;
      _handleCurrentInteraction(hasSelection, hasTooltip, localPosition, kind: details.kind);
    }
  ...
  void handleLongPressStart(LongPressStartDetails details) {
    ...
    if (parent != null && _interactiveSegment != null) {
      final bool hasSelection = _selectionEnabled && parent!.selectionGesture == ActivationMode.longPress;
      final bool hasTooltip = _tooltipEnabled && parent!.tooltipBehavior!.activationMode == ActivationMode.longPress;
  ...
  void handleTapUp(TapUpDetails details) {
    final Offset localPosition = globalToLocal(details.globalPosition);
    if (parent != null && _interactiveSegment != null) {
      final bool hasSelection = _selectionEnabled && parent!.selectionGesture == ActivationMode.singleTap;
      final bool hasTooltip = _tooltipEnabled && parent!.tooltipBehavior!.activationMode == ActivationMode.singleTap;
      _handleCurrentInteraction(hasSelection, hasTooltip, localPosition);
    }
  ...
  void handleDoubleTap(Offset position) {
    ...
    if (parent != null && _interactiveSegment != null) {
      final bool hasSelection = _selectionEnabled && parent!.selectionGesture == ActivationMode.doubleTap;
      final bool hasTooltip = _tooltipEnabled && parent!.tooltipBehavior!.activationMode == ActivationMode.doubleTap;
      _handleCurrentInteraction(hasSelection, hasTooltip, localPosition);
    }
  ...
  void _handleCurrentInteraction(bool hasSelection, bool hasTooltip, Offset position,
  ...
  void _updateSelectionToVisual(int seriesIndex, int segmentPointIndex, {bool elected = false}) {
    if (parent == null || selectionBehavior == null || !selectionBehavior!.enable) {
      return;
    }
  ...
  bool isEmpty(int segmentIndex) {
    ...
    segmentIndex = sortedIndexes.isNotEmpty ? sortedIndexes[segmentIndex] : segmentIndex;
    int start = 0;
  ...
  void _fetchMarkerImage() {
    if (markerSettings.shape == DataMarkerType.image && markerSettings.image != null) {
  ...
  void _calculateEffectiveSelectedIndexes() {
    if (parent != null &&
      ...
      final RangeController? selectionController = effectiveSelectionBehavior?.selectionController;
      ...
      } else if (initialSelectedDataIndexes != null && initialSelectedDataIndexes!.isNotEmpty) {
      ...
      if (effectiveSelectedIndexes.isNotEmpty) {
        ...
        if ((initialSelectedDataIndexes == null || initialSelectedDataIndexes!.isEmpty) &&
            selectionController != null) {
          final List<int>? base = parent?.selectionController.selectedDataPoints[index];
          if (base != null) {
            final List<int> result = base.where((element) => !effectiveSelectedIndexes.contains(element)).toList();
  ...
  @mustCallSuper
  void performLayout() {
    if (!isVisible() || constraints.maxWidth <= 0.0 || constraints.maxHeight <= 0.0) {
      return;
    }
    ...
    if (canUpdateOrCreateSegments || _isXRangeChanged || _isYRangeChanged || _isResized || forceTransformValues) {
      transformValues();
    }
  ...
  void copyOldSegmentValues(double animationFactor, double segmentAnimationFactor) {
...
abstract class ChartSegment {
  ...
  void copyOldSegmentValues(double seriesAnimationFactor, double segmentAnimationFactor) {}
...
class ChartSeriesController<T, D> {
  ...
  void updateDataSource({
    ...
    final CartesianRealTimeUpdateMixin<T, D>? renderer = seriesRenderer as CartesianRealTimeUpdateMixin<T, D>?;
    if (renderer != null) {
  ...
  CartesianChartPoint<D> pixelToPoint(Offset position) {
    if (seriesRenderer.parent == null || seriesRenderer.parent!.parentData == null || seriesRenderer.xAxis == null) {
      return CartesianChartPoint<D>();
    }

    final BoxParentData parentData = seriesRenderer.parent!.parentData! as BoxParentData;
    final Rect seriesBounds = seriesRenderer.paintBounds;
    position -= parentData.offset;
    double xValue = seriesRenderer.xAxis!.pixelToPoint(seriesBounds, position.dx, position.dy);
    final num yValue = seriesRenderer.yAxis!.pixelToPoint(seriesBounds, position.dx, position.dy);

    if (seriesRenderer.xAxis is RenderCategoryAxis || seriesRenderer.xAxis is RenderDateTimeCategoryAxis) {
...
abstract class CartesianSeries<T, D> extends ChartSeries<T, D> {
    ...
    switch (slot) {
      ...
      case SeriesSlot.marker:
        return markerSettings.isVisible
            ...
            ? MarkerContainer<T, D>(series: this, dataSource: dataSource!, settings: markerSettings)
            : null;

      case SeriesSlot.trendline:
        return trendlines != null ? TrendlineContainer(trendlines: trendlines!) : null;
    }
  }

  @override
  CartesianSeriesRenderer<T, D> createRenderObject(BuildContext context) {
    final CartesianSeriesRenderer<T, D> renderer = super.createRenderObject(context) as CartesianSeriesRenderer<T, D>;
    renderer
      ..xAxisName = xAxisName
      ..yAxisName = yAxisName
      ..color = color
  ...
  @override
  void updateRenderObject(BuildContext context, CartesianSeriesRenderer<T, D> renderObject) {
...
abstract class CartesianSeriesRenderer<T, D> extends ChartSeriesRenderer<T, D> with AxisDependent {
  List<int> visibleIndexes = <int>[];

  ChartSeriesController<T, D> get controller => _controller;
  late final ChartSeriesController<T, D> _controller = ChartSeriesController<T, D>(this);
  ...
  set dataSource(List<T>? value) {
    ...
    if (_dataCount != value?.length || !listEquals(_dataSource, value)) {
      ...
      if (xAxis != null && yAxis != null && parent != null && parent!.enableAxisAnimation) {
        populateDataSource();
  ...
  SeriesRendererCreatedCallback<T, D>? get onRendererCreated => _onRendererCreated;
  ...
  Shader? legendIconShader() {
    if (parent != null && parent!.legend != null) {
      final Rect legendIconBounds = Rect.fromLTWH(0.0, 0.0, parent!.legend!.iconWidth, parent!.legend!.iconHeight);
  ...
  void _resetDataSourceHolders() {
    ...
    final DoubleRange defaultXRange = xAxis?.defaultRange() ?? DoubleRange(0, 1);
    final DoubleRange defaultYRange = yAxis?.defaultRange() ?? DoubleRange(0, 1);
  ...
  void populateChartPoints({
    ...
    for (int i = 0; i < dataCount; i++) {
      ...
      final CartesianChartPoint<D> point = CartesianChartPoint<D>(x: xRawValues[i], xValue: xValue);
      for (int j = 0; j < yLength; j++) {
        point[positions[j]] = yLists[j][i];
      }
      chartPoints.add(point);
  ...
  DoubleRange _trendlineRange(DoubleRange actualRange, RenderChartAxis axis) {
    ...
    final DoubleRange trendlineRange = trendlineContainer!.range(axis, actualRange);
  ...
  void _findVisibleIndexes() {
    visibleIndexes.clear();
    if (xAxis == null || xAxis!.visibleRange == null || xAxis!.visibleInterval == 0) {
      return;
    }
    ...
    if (xAxis is RenderLogarithmicAxis) {
      range = DoubleRange(_valueAsPow(baseRange.minimum), _valueAsPow(baseRange.maximum));
    } else {
      range = baseRange;
    }
  ...
  ChartDataLabelAlignment effectiveDataLabelAlignment(
    ...
    if (alignment == ChartDataLabelAlignment.auto) {
      ...
      if (isPrevEmpty && isNextEmpty) {
        ...
        return current.y! < next!.y! ? ChartDataLabelAlignment.bottom : ChartDataLabelAlignment.top;
      } else if (isNextEmpty) {
        return current.y! < previous.y! ? ChartDataLabelAlignment.bottom : ChartDataLabelAlignment.top;
      } else {
        final num slope = (next.y! - previous.y!) / 2;
        final num intersectY = (slope * index) + (next.y! - (slope * (index + 1)));
        return current.y! < intersectY ? ChartDataLabelAlignment.bottom : ChartDataLabelAlignment.top;
      }
    } else {
      return alignment;
    }
  ...
  Offset dataLabelPosition(
    ...
    switch (alignment) {
      ...
      case ChartDataLabelAlignment.top:
        if (isTransposed) {
          translationX =
              y.isNegative ? -(markerWidthWithPadding + size.width + margin.horizontal) : markerWidthWithPadding;
          translationY = -margin.top;
        } else {
          translationX = -margin.left;
          translationY =
              y.isNegative ? markerHeightWithPadding : -(markerHeightWithPadding + size.height + margin.vertical);
        }
      ...
      case ChartDataLabelAlignment.bottom:
        if (isTransposed) {
          translationX =
              y.isNegative ? markerWidthWithPadding : -(markerWidthWithPadding + size.width + margin.horizontal);
          translationY = -margin.top;
        } else {
          translationX = -margin.left;
          translationY =
              y.isNegative ? -(markerHeightWithPadding + size.height + margin.vertical) : markerHeightWithPadding;
        }
        return translateTransform(current.x!, y, translationX, translationY);
      ...
      case ChartDataLabelAlignment.middle:
        ...
        return translateTransform(current.x!, current.y!, translationX, translationY);
    }
  }
  ...
  void updateSegmentGradient(
    ...
    if (!segment.isEmpty) {
      ...
      if (borderGradient != null && gradientBounds != null) {
        ...
        segment.strokePaint.shader =
            borderGradient.createShader(gradientBounds.deflate(segment.strokePaint.strokeWidth / 2));
      }
    }
  }
  ...
  void paintTrendline(PaintingContext context, Offset offset) {
    if (trendlineContainer != null && parent != null && parent!.render == SeriesRender.trendline) {
      context.canvas.save();
      context.canvas
          .clipRect(clipRect(paintBounds, animationFactor, isInversed: xAxis!.isInversed, isTransposed: isTransposed));
  ...
  void paintMarkers(PaintingContext context, Offset offset) {
    if (markerContainer != null && parent != null && parent!.render == SeriesRender.normal) {
  ...
  void paintDataLabels(PaintingContext context, Offset offset) {
    if (dataLabelContainer != null && parent != null && parent!.render == SeriesRender.dataLabel) {
    ...
    if (!offset.dx.isNaN && !offset.dy.isNaN) {
      if (dataLabel.isNotEmpty) {
        ...
        if (fillPaint.color != Colors.transparent ||
            (strokePaint.color != const Color.fromARGB(0, 25, 5, 5) && strokePaint.strokeWidth > 0)) {
          ...
          RRect labelRect = RRect.fromRectAndRadius(dataLabelRect, Radius.circular(dataLabelSettings.borderRadius));
          // To check and update the label rect and offset by rotated
          // label rect height overlaps with plotArea or not.
          if (angle != 0) {
            final Rect rotatedBounds = calculateRotatedBounds(dataLabelRect, dataLabelSettings.angle);
            final double heightFromCenter = rotatedBounds.height / 2;
            if (paintBounds.bottom < labelRect.center.dy + heightFromCenter) {
              labelRect = _rotatedRRect(labelRect, labelRect.bottom - heightFromCenter);
              offset = Offset(labelRect.left, labelRect.top);
            }
            if (paintBounds.top > labelRect.center.dy - heightFromCenter) {
              labelRect = _rotatedRRect(labelRect, labelRect.top + heightFromCenter);
              offset = Offset(labelRect.left, labelRect.top);
            }
          }
          ...
          canvas.translate(-labelRect.center.dx, -labelRect.center.dy);
          if (strokePaint.color != Colors.transparent && strokePaint.strokeWidth > 0) {
  ...
  RRect _rotatedRRect(RRect labelRect, double labelY) {
    return RRect.fromRectAndRadius(
        Rect.fromCenter(center: Offset(labelRect.center.dx, labelY), width: labelRect.width, height: labelRect.height),
  ...
  void drawDataLabel(
    ...
    if (!pointX.isNaN && !pointY.isNaN) {
      ...
      textPainter.layout();
      canvas.save();
      canvas.translate(pointX + textPainter.width / 2, pointY + textPainter.height / 2);
      canvas.rotate(degreeToRadian(angle));
      final Offset labelOffset = Offset(-textPainter.width / 2, -textPainter.height / 2);
...
mixin ContinuousSeriesMixin<T, D> on CartesianSeriesRenderer<T, D> {
  ...
  int segmentPointIndex(Offset position, ChartSegment segment) {
    ...
    for (int i = 0; i < length; i++) {
      final Rect bounds = Rect.fromCenter(center: segment.points[i], width: tooltipPadding, height: tooltipPadding);
...
mixin RealTimeUpdateMixin<T, D> on ChartSeriesRenderer<T, D> {
  void updateDataPoints(
    ...
    if (removedIndexes != null) {
      _removeDataPoints(removedIndexes, yPaths, chaoticYLists, yLists, fPaths, chaoticFLists, fLists);
    }

    if (addedIndexes != null) {
      _addDataPoints(addedIndexes, yPaths, chaoticYLists, yLists, fPaths, chaoticFLists, fLists);
    }

    if (replacedIndexes != null) {
      _replaceDataPoints(replacedIndexes, yPaths, chaoticYLists, yLists, fPaths, chaoticFLists, fLists);
    }
  ...
  void _removeDataPoints(
    ...
    _replaceDataPoints(mutableIndexes, yPaths, chaoticYLists, yLists, fPaths, chaoticFLists, fLists);
  }
    ...
    for (final int index in indexes) {
      ...
      for (int i = 0; i < yPathLength; i++) {
        ...
        if (yValue == null || yValue.isNaN) {
          ...
          index > chaoticYLists![i].length - 1 ? chaoticYLists[i].add(yValue) : chaoticYLists[i].insert(index, yValue);
          index > xValues.length - 1 ? _chaoticXValues.add(index) : _chaoticXValues.insert(index, xValues[index]);
          index > xRawValues.length - 1 ? _chaoticRawXValues.add(rawX) : _chaoticRawXValues.insert(index, rawX);

          if (sortFieldValueMapper == null && sortingOrder != SortingOrder.none) {
  ...
  void _removeRawSortValueAt(int index) {
    if (sortFieldValueMapper == null && sortingOrder != SortingOrder.none && _chaoticRawSortValues.isNotEmpty) {
...
mixin CartesianRealTimeUpdateMixin<T, D> on CartesianSeriesRenderer<T, D> {
  void updateDataPoints(
    ...
    if (xValueMapper == null || yPaths == null || yPaths.isEmpty || chaoticYLists == null || chaoticYLists.isEmpty) {
      return;
    }
    ...
    _updateAxisRange(xRange.minimum, xRange.maximum, yRange.minimum, yRange.maximum);
    computeNonEmptyYValues();
    _populateTrendlineDataSource();
    _updateXValuesForCategoryTypeAxes();
  ...
  void _addDataPoints(
    ...
    final int fPathLength = fPaths?.length ?? 0;
    final Function(int, D) preferredXValue = _preferredXValue();
    final Function(int, D?, num) insertXValue = _insertXValueIntoRawAndChaoticXLists;
    final Function(int, D?) insertRawSortValue = _insertRawXValueIntoChaoticRawSortValue;
    ...
    for (final int index in indexes) {
      ...
      if (_callbacksEnabled) {
        ...
        final CartesianChartPoint<D> point = CartesianChartPoint<D>(x: _chaoticRawXValues[index], xValue: xValue);
        for (int j = 0; j < yPathLength; j++) {
          point[positions[j]] = chaoticYLists![j][index];
        }
        chartPoints.insert(index, point);
  ...
  void _updateAxisRange(num xMinimum, num xMaximum, num yMinimum, num yMaximum) {
  ...
  void _replaceDataPoints(
    ...
    //    continuous series.
    final Function(int, D) preferredXValue = _preferredXValue();
    final Function(int, D?, num) replaceXValue = _updateXValueIntoRawAndChaoticXLists;
    final Function(int, D?) replaceRawSortValue = _updateRawXValueIntoChaoticRawSortValue;
...
mixin SbsSeriesMixin<T, D> on CartesianSeriesRenderer<T, D> {
  ...
  set spacing(double value) {
    assert(value >= 0 && value <= 1, 'The spacing of the series should be between 0 and 1');
    if (value != _spacing) {
      _spacing = value;
    }
  }
  ...
  set width(double value) {
    assert(value >= 0 && value <= 1, 'The width of the series should be between 0 and 1');
    if (value != _width) {
      _width = value;
    }
  }
  ...
  void _calculateSbsInfo() {
    ...
    if (length == 1) {
      ...
      final num seriesMin =
          (xAxis is RenderDateTimeAxis && xRange.minimum == xRange.maximum) ? minimumInSeconds! : xRange.minimum;
  ...
  void updateSegmentTrackerStyle(
      ChartSegment segment, Color trackColor, Color trackBorderColor, double trackBorderWidth) {
  ...
  @override
  Offset dataLabelPosition(ChartElementParentData current, ChartDataLabelAlignment alignment, Size size) {
    ...
    switch (current.position) {
      case ChartDataPointType.y:
        ...
        return _calculateYPosition(x, y, alignment, size, isNegative: current.y!.isNegative);
  ...
  Offset _calculateYPosition(num x, num y, ChartDataLabelAlignment alignment, Size size, {bool isNegative = false}) {
    final EdgeInsets margin = dataLabelSettings.margin;
    double translationX = 0.0;
    double translationY = 0.0;
    switch (alignment) {
      ...
      case ChartDataLabelAlignment.bottom:
        if (isTransposed) {
          translationX = isNegative ? -(dataLabelPadding + size.width + margin.horizontal) : dataLabelPadding;
          translationY = -margin.top;
        } else {
          translationX = -margin.left;
          translationY = isNegative ? dataLabelPadding : -(dataLabelPadding + size.height + margin.vertical);
        }
        return translateTransform(x, y, translationX, translationY);

      case ChartDataLabelAlignment.top:
        if (isTransposed) {
          translationX = isNegative ? dataLabelPadding : -(dataLabelPadding + size.width + margin.horizontal);
          translationY = -margin.top;
        } else {
          translationX = -margin.left;
          translationY = isNegative ? -(dataLabelPadding + size.height + margin.vertical) : dataLabelPadding;
        }
        return translateTransform(x, y, translationX, translationY);
  ...
  Offset _calculateHighPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.bottom:
  ...
  Offset _calculateLowPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.bottom:
  ...
  Offset _calculateDataLabelOpenPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.top:
  ...
  Offset _calculateDataLabelClosePosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.top:
  ...
  Offset _calculateMedianPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.top:
  ...
  Offset _calculateOutlierPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      case ChartDataLabelAlignment.auto:
      case ChartDataLabelAlignment.outer:
      case ChartDataLabelAlignment.top:
...
abstract class XyDataSeries<T, D> extends CartesianSeries<T, D> {
  ...
  @override
  List<ChartDataPointType> get positions => <ChartDataPointType>[ChartDataPointType.y];

  @override
  XyDataSeriesRenderer<T, D> createRenderObject(BuildContext context) {
    final XyDataSeriesRenderer<T, D> renderer = super.createRenderObject(context) as XyDataSeriesRenderer<T, D>;
    renderer.yValueMapper = yValueMapper;
    return renderer;
  }

  @override
  void updateRenderObject(BuildContext context, XyDataSeriesRenderer<T, D> renderObject) {
    super.updateRenderObject(context, renderObject);
...
abstract class XyDataSeriesRenderer<T, D> extends CartesianSeriesRenderer<T, D>
  ...
  void updateDataPoints(
    ...
    super.updateDataPoints(
        removedIndexes, addedIndexes, replacedIndexes, yPaths, chaoticYLists, yLists, fPaths, chaoticFLists, fLists);
  }
  ...
  void computeNonEmptyYValues() {
    nonEmptyYValues.clear();
    if (emptyPointSettings.mode == EmptyPointMode.gap || emptyPointSettings.mode == EmptyPointMode.drop) {
  ...
  @override
  void _populateTrendlineDataSource() {
    trendlineContainer?.populateDataSource(xValues, seriesYValues: nonEmptyYValues);
  }
  ...
  void performLayout() {
    ...
    if (this is! StackedSeriesRenderer && this is! WaterfallSeriesRenderer) {
      ...
      if (dataLabelContainer != null) {
        ...
        if (dataLabelSettings.isVisible && dataLabelSettings.labelIntersectAction != LabelIntersectAction.none) {
...
abstract class StackedSeriesBase<T, D> extends XyDataSeries<T, D> {
  ...
  StackedSeriesRenderer<T, D> createRenderObject(BuildContext context) {
    final StackedSeriesRenderer<T, D> renderer = super.createRenderObject(context) as StackedSeriesRenderer<T, D>;
    renderer
  ...
  @override
  void updateRenderObject(BuildContext context, StackedSeriesRenderer<T, D> renderObject) {
    super.updateRenderObject(context, renderObject);
    renderObject
      ..trackColor = trackColor
      ..trackBorderColor = trackBorderColor
...
abstract class StackedSeriesRenderer<T, D> extends XyDataSeriesRenderer<T, D> with StackingSeriesMixin {
  ...
  void _applyDropOrGapEmptyPointModes(StackedSeriesRenderer<T, D> series) {
    ...
    if (emptyPointSettings.mode == EmptyPointMode.gap || emptyPointSettings.mode == EmptyPointMode.drop) {
      ...
      final bool isStackedBar = seriesType.contains('stackedcolumn') || seriesType.contains('stackedbar');
      for (int i = 0; i < dataCount; i++) {
  ...
  void _calculateStackingValues(StackedSeriesRenderer<T, D> series) {
    ...
    for (final AxisDependent yDependant in yDependents) {
      ...
      _computeStackedValues(
          current, currentPositiveStackInfo, positiveValues, negativeValues, _isStacked100, groupName);
  ...
  void _computeStackedValues(
    ...
    final bool isDropOrGapMode = emptyPointMode == EmptyPointMode.drop || emptyPointMode == EmptyPointMode.gap;
  ...
  void _calculatePercentageValues(List<AxisDependent> yDependents) {
    ...
    for (final AxisDependent yDependant in yDependents) {
      ...
      final String seriesType = current.runtimeType.toString().toLowerCase();
      final bool isContainsStackedArea100 = seriesType.contains('stackedarea100');
      final String groupName = isContainsStackedArea100 ? 'stackedareagroup' : current.groupName;
      ...
      for (int i = 0; i < length; i++) {
        ...
        if (stackingInfo!.stackingValues.containsKey(xValue)) {
          if (yValue >= 0) {
            stackingInfo.stackingValues[xValue] = stackingInfo.stackingValues[xValue]! + yValue;
          } else {
            stackingInfo.stackingValues[xValue] = stackingInfo.stackingValues[xValue]! - yValue;
          }
        }
  ...
  void drawDataLabelWithBackground(
    ...
    if (dataLabelMapper == null && parent!.onDataLabelRender == null && !dataLabelSettings.showCumulativeValues) {
    ...
    super.drawDataLabelWithBackground(index, canvas, dataLabel, offset, angle, style, fillPaint, strokePaint);
  }
...
abstract class RangeSeriesBase<T, D> extends CartesianSeries<T, D> {
  ...
  @override
  List<ChartDataPointType> get positions => <ChartDataPointType>[ChartDataPointType.high, ChartDataPointType.low];

  @override
  RangeSeriesRendererBase<T, D> createRenderObject(BuildContext context) {
    final RangeSeriesRendererBase<T, D> renderer = super.createRenderObject(context) as RangeSeriesRendererBase<T, D>;
  ...
  @override
  void updateRenderObject(BuildContext context, RangeSeriesRendererBase<T, D> renderObject) {
    super.updateRenderObject(context, renderObject);
...
abstract class RangeSeriesRendererBase<T, D> extends CartesianSeriesRenderer<T, D>
    with CartesianRealTimeUpdateMixin<T, D> {
  ...
  void populateDataSource([
    ...
    if (highValueMapper != null && lowValueMapper != null) {
      if (sortingOrder == SortingOrder.none) {
        super.populateDataSource(<ChartValueMapper<T, num>>[highValueMapper!, lowValueMapper!],
            <List<num>>[highValues, lowValues], <List<num>>[], fPaths, chaoticFLists, fLists);
      } else {
  ...
  void _populateTrendlineDataSource() {
    trendlineContainer?.populateDataSource(xValues,
        seriesHighValues: nonEmptyHighValues, seriesLowValues: nonEmptyLowValues);
  }
  ...
  void populateChartPoints({
    ...
    if (yLists == null) {
      yLists = <List<num>>[highValues, lowValues];
      positions = <ChartDataPointType>[ChartDataPointType.high, ChartDataPointType.low];
    } else {
      yLists.add(highValues);
      yLists.add(lowValues);
    ...
    switch (current.position) {
      ...
      case ChartDataPointType.high:
        switch (alignment) {
          ...
          case ChartDataLabelAlignment.outer:
          case ChartDataLabelAlignment.top:
            return super.dataLabelPosition(current, ChartDataLabelAlignment.outer, size);

          case ChartDataLabelAlignment.bottom:
            return super.dataLabelPosition(current, ChartDataLabelAlignment.bottom, size);

          case ChartDataLabelAlignment.middle:
            return super.dataLabelPosition(current, ChartDataLabelAlignment.middle, size);
        }
...
abstract class FinancialSeriesBase<T, D> extends CartesianSeries<T, D> {
  ...
  @override
  void updateRenderObject(BuildContext context, FinancialSeriesRendererBase<T, D> renderObject) {
    super.updateRenderObject(context, renderObject);
    renderObject
      ..volumeValueMapper = volumeValueMapper
      ..openValueMapper = openValueMapper
...
abstract class FinancialSeriesRendererBase<T, D> extends CartesianSeriesRenderer<T, D>
    with SbsSeriesMixin<T, D>, ClusterSeriesMixin, CartesianRealTimeUpdateMixin<T, D> {
  ...
  void populateDataSource([
    ...
    if (highValueMapper != null && lowValueMapper != null && openValueMapper != null && closeValueMapper != null) {
      ...
      if (sortingOrder == SortingOrder.none) {
        super.populateDataSource(mappers, finalYLists, <List<num>>[], fPaths, chaoticFLists, fLists);
      } else {
        super.populateDataSource(
          mappers,
          <List<num>>[
  ...
  void updateDataPoints(
    ...
    if (highValueMapper != null && lowValueMapper != null && openValueMapper != null && closeValueMapper != null) {
      ...
      if (sortingOrder == SortingOrder.none) {
        super.updateDataPoints(removedIndexes, addedIndexes, replacedIndexes, mappers, finalYLists, <List<num>>[],
            fPaths, chaoticFLists, fLists);
      } else {
        _resetYLists();
        super.updateDataPoints(
            removedIndexes,
  ...
  @override
  void _populateTrendlineDataSource() {
    trendlineContainer?.populateDataSource(xValues, seriesHighValues: highValues, seriesLowValues: lowValues);
  }
  ...
  @override
  ChartDataLabelAlignment effectiveDataLabelAlignment(ChartDataLabelAlignment alignment, ChartDataPointType position,
      ChartElementParentData? previous, ChartElementParentData current, ChartElementParentData? next) {
    ...
    if (position == ChartDataPointType.open) {
      ...
      return open <= close ? ChartDataLabelAlignment.top : ChartDataLabelAlignment.bottom;
    } else if (position == ChartDataPointType.close) {
      final num open = openValues[index];
      final num close = closeValues[index];
      return close <= open ? ChartDataLabelAlignment.top : ChartDataLabelAlignment.bottom;
    }

    return alignment == ChartDataLabelAlignment.auto ? ChartDataLabelAlignment.outer : alignment;
  }
  ...
  Offset _calculateDataLabelOpenPosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      ...
      case ChartDataLabelAlignment.top:
      case ChartDataLabelAlignment.middle:
        return _calculateOpenAndClosePosition(x, y, ChartDataLabelAlignment.outer, size, ChartDataPointType.open);

      case ChartDataLabelAlignment.bottom:
        return _calculateOpenAndClosePosition(x, y, ChartDataLabelAlignment.top, size, ChartDataPointType.open);
    }
  }
  ...
  Offset _calculateDataLabelClosePosition(num x, num y, ChartDataLabelAlignment alignment, Size size) {
    switch (alignment) {
      ...
      case ChartDataLabelAlignment.top:
      case ChartDataLabelAlignment.middle:
        return _calculateOpenAndClosePosition(x, y, ChartDataLabelAlignment.outer, size, ChartDataPointType.close);

      case ChartDataLabelAlignment.bottom:
        return _calculateOpenAndClosePosition(x, y, ChartDataLabelAlignment.top, size, ChartDataPointType.close);
    }
  }
...
abstract class CircularSeries<T, D> extends ChartSeries<T, D> {
  ...
  CircularSeriesRenderer<T, D> createRenderObject(BuildContext context) {
    final CircularSeriesRenderer<T, D> renderer = super.createRenderObject(context) as CircularSeriesRenderer<T, D>;
    renderer
  ...
  @override
  void updateRenderObject(BuildContext context, CircularSeriesRenderer<T, D> renderObject) {
    super.updateRenderObject(context, renderObject);
    renderObject
      ..yValueMapper = yValueMapper
      ..pointShaderMapper = pointShaderMapper
...
abstract class CircularSeriesRenderer<T, D> extends ChartSeriesRenderer<T, D>
  ...
  late final CircularSeriesController<T, D> _controller = CircularSeriesController<T, D>(this);
  ...
  ChartShaderDetails createShaderDetails() {
    final Rect innerRect = Rect.fromCircle(center: center, radius: currentInnerRadius);
    final Rect outerRect = Rect.fromCircle(center: center, radius: currentRadius);
    ...
    for (int i = 0; i < dataCount; i++) {
      ...
      if (groupTo != null &&
          ((groupMode == CircularChartGroupMode.point && i >= groupTo!) ||
              (groupMode == CircularChartGroupMode.value && yValue <= groupTo!))) {
  ...
  void _calculateCircularValues() {
    ...
    totalAngle = startDegree > endDegree ? (startDegree - 360).abs() + endDegree : (startDegree - endDegree).abs();
    ...
    center = Offset(percentToValue(centerX, size.width)!, percentToValue(centerY, size.height)!);
    ...
    if (parent != null && parent!.legend != null) {
      ...
      if (pointShaderMapper != null) {
        return pointShaderMapper!(
            dataSource![pointIndex], pointIndex, palette[pointIndex % palette.length], legendIconBounds);
      } else if (onCreateShader != null) {
        final ChartShaderDetails details = ChartShaderDetails(legendIconBounds, legendIconBounds, 'legend');
        return onCreateShader?.call(details);
      }
    }
    return null;
  ...
  void updateSegmentGradient(ChartSegment segment) {
    ...
    if (!segment.isEmpty && dataSource != null && segmentIndex < dataSource!.length) {
      if (pointShaderMapper != null) {
        final Shader shader = pointShaderMapper!(dataSource![segmentIndex], segmentIndex,
            palette[segmentIndex % palette.length], Rect.fromCircle(center: center, radius: currentRadius));
        ...
        final List<Color> colors = List<Color>.generate(segments.length, (int i) => palette[i % palette.length]);
        ...
        segment.fillPaint.shader =
            sweep.createShader(createShaderDetails().outerRect, textDirection: TextDirection.ltr);
      }
    }
  }
  ...
  Offset dataLabelPosition(CircularDataLabelBoxParentData current, Size size) {
    ...
    if (point.isExplode) {
      point.center =
          calculateExplodingCenter(point.midAngle!, point.outerRadius!.toDouble(), point.center!, point.explodeOffset);
    }
    if (point.isVisible && (point.y != 0 || dataLabelSettings.showZeroValue)) {
      dataLabelStyle = dataLabelStyle.copyWith(
          color: dataLabelStyle.color ?? saturatedTextColor(findThemeColor(this, point, dataLabelSettings)));

      if (dataLabelSettings.labelPosition == ChartDataLabelPosition.inside) {
        labelLocation = calculateOffset(point.midAngle!, (point.innerRadius! + point.outerRadius!) / 2, point.center!);
        labelLocation = Offset(labelLocation.dx - (size.width / 2) + (angle == 0 ? 0 : size.width / 2),
            labelLocation.dy - (size.height / 2) + (angle == 0 ? 0 : size.height / 2));
        point.labelRect = Rect.fromLTWH(labelLocation.dx - labelPadding, labelLocation.dy - labelPadding,
            size.width + (2 * labelPadding), size.height + (2 * labelPadding));
        bool isDataLabelCollide = findingCollision(point.labelRect, renderDataLabelRegions);
        if (dataLabelSettings.labelIntersectAction == LabelIntersectAction.hide ||
        ...
        if (dataLabelSettings.builder == null) {
          ...
          if (dataLabelSettings.overflowMode == OverflowMode.shift) {
            final String labelText = segmentOverflowTrimmedText(this, point.text!, size, point, point.labelRect, center,
                labelLocation, dataLabelSettings.overflowMode, dataLabelStyle);
          ...
          } else if (dataLabelSettings.overflowMode == OverflowMode.trim && !point.text!.contains('...')) {
            if (!isDataLabelCollide) {
              point.text = segmentOverflowTrimmedText(this, point.text!, size, point, point.labelRect, center,
                  labelLocation, dataLabelSettings.overflowMode, dataLabelStyle);
              label = point.text!;
              final Size trimmedTextSize = measureText(label, dataLabelStyle);
              labelLocation =
                  calculateOffset(point.midAngle!, (point.innerRadius! + point.outerRadius!) / 2, point.center!);
              labelLocation = Offset(
                  labelLocation.dx - (trimmedTextSize.width / 2) + (angle == 0 ? 0 : trimmedTextSize.width / 2),
                  labelLocation.dy - (trimmedTextSize.height / 2) + (angle == 0 ? 0 : trimmedTextSize.height / 2));
              point.labelLocation = labelLocation;
              point.labelRect = Rect.fromLTWH(labelLocation.dx - labelPadding, labelLocation.dy - labelPadding,
                  trimmedTextSize.width + (2 * labelPadding), trimmedTextSize.height + (2 * labelPadding));
            } else {
        ...
        if (dataLabelSettings.labelIntersectAction == LabelIntersectAction.shift &&
            isDataLabelCollide &&
            dataLabelSettings.overflowMode != OverflowMode.trim) {
          point.saturationRegionOutside = true;
          point.renderPosition = ChartDataLabelPosition.outside;
          renderOutsideDataLabel(point, size, pointIndex, this, index, dataLabelStyle, renderDataLabelRegions);
        } else if (((dataLabelSettings.labelIntersectAction == LabelIntersectAction.shift &&
                    dataLabelSettings.overflowMode == OverflowMode.none) &&
                isDataLabelCollide &&
                dataLabelSettings.overflowMode != OverflowMode.trim) ||
            (isDataLabelCollide && dataLabelSettings.overflowMode == OverflowMode.shift)) {
          point.saturationRegionOutside = true;
          point.renderPosition = ChartDataLabelPosition.outside;
          renderOutsideDataLabel(point, size, pointIndex, this, index, dataLabelStyle, renderDataLabelRegions);
          ...
          if (!isDataLabelCollide &&
              (dataLabelSettings.labelIntersectAction == LabelIntersectAction.shift &&
                  dataLabelSettings.overflowMode != OverflowMode.hide)) {
            renderDataLabelRegions.add(point.labelRect);
            point.labelLocation = labelLocation;
          } else if (!isDataLabelCollide &&
              (dataLabelSettings.labelIntersectAction == LabelIntersectAction.hide ||
                  dataLabelSettings.overflowMode == OverflowMode.hide)) {
  ...
  void drawDataLabelWithBackground(
    ...
    Color surfaceColor = dataLabelSurfaceColor(
        fillPaint.color, index, dataLabelSettings.labelPosition, chartThemeData, themeData, segment);
    ...
    if (point.saturationRegionOutside &&
      ...
      if (style.color == Colors.transparent) {
        surfaceColor = dataLabelSurfaceColor(
            fillPaint.color, index, ChartDataLabelPosition.outside, chartThemeData, themeData, segment);
    ...
    canvas.rotate((angle * pi) / 180);
    canvas.translate(-labelRect.center.dx, -labelRect.center.dy);
    if (dataLabelSettings.borderWidth > 0 && strokePaint.color != Colors.transparent) {
      _drawLabelRect(strokePaint, Rect.fromLTRB(labelRect.left, labelRect.top, labelRect.right, labelRect.bottom),
          dataLabelSettings.borderRadius, canvas);
    }

    if (fillPaint.color != Colors.transparent) {
      _drawLabelRect(fillPaint, Rect.fromLTRB(labelRect.left, labelRect.top, labelRect.right, labelRect.bottom),
          dataLabelSettings.borderRadius, canvas);
    }
    canvas.restore();

    drawDataLabel(canvas, dataLabel, offset, effectiveTextStyle, dataLabelSettings.angle);
  }
  ...
  void drawConnectorLine(Path connectorPath, Canvas canvas, int index) {
    ...
    canvas.drawPath(
        connectorPath,
        Paint()
          ..color = line.width <= 0 ? Colors.transparent : line.color ?? segments[index].fillPaint.color
          ..strokeWidth = line.width
          ..style = PaintingStyle.stroke);
  }

  void _drawLabelRect(Paint paint, Rect labelRect, double borderRadius, Canvas canvas) =>
      canvas.drawRRect(RRect.fromRectAndRadius(labelRect, Radius.circular(borderRadius)), paint);

  void drawDataLabel(Canvas canvas, String text, Offset point, TextStyle style, int angle, [bool? isRtl]) {
...
abstract class BoxAndWhiskerSeriesRendererBase<T, D> extends CartesianSeriesRenderer<T, D>
    with SbsSeriesMixin<T, D>, ClusterSeriesMixin, CartesianRealTimeUpdateMixin<T, D> {
  ...
  void populateDataSource([
    ...
    _resetDataSourceHolders();
    if (dataSource == null || dataSource!.isEmpty || xValueMapper == null || yValueMapper == null) {
      _dataCount = _chaoticXValues.length;
      return;
    }
  ...
  void _sortBoxValues(List<List<Object?>>? chaoticFLists, List<List<Object?>>? fLists, {bool ascending = true}) {
    _computeSortedIndexes(ascending);
    if (sortedIndexes.isNotEmpty) {
      final void Function(int index, num xValue) copyX =
          _chaoticRawXValues.isNotEmpty ? _copyXAndRawXValue : _copyXValue;
...
abstract class HistogramSeriesRendererBase<T, D> extends XyDataSeriesRenderer<T, D>
  ...
  void _populateDataSource() {
    _resetDataHolders();
    if (dataSource == null || dataSource!.isEmpty || super.yValueMapper == null) {
      return;
    }
  ...
  void _calculateStandardDeviation() {
    ...
    for (int i = 0; i < yLength;) {
      final num count = _yRawValues.where((num y) => y >= minValue && y < (minValue + binWidth)).length;
      if (count >= 0) {
  ...
  void _createNormalDistributionPath() {
    ...
    for (int i = 0; i < pointsCount; i++) {
      ...
      final num yValue = exp(-pow(xValue - _mean, 2) / (2 * pow(_deviation, 2))) / (_deviation * sqrt(2 * pi));
  ...
  void onPaint(PaintingContext context, Offset offset) {
    ...
    if (showNormalDistributionCurve) {
      context.canvas.save();
      final Rect clip =
          clipRect(paintBounds, segmentAnimationFactor, isInversed: xAxis!.isInversed, isTransposed: isTransposed);
      ...
      curveDashArray == null
          ...
          : drawDashes(context.canvas, curveDashArray, strokePaint, path: _distributionPath);
    }
    context.canvas.restore();
    paintMarkers(context, offset);
    paintDataLabels(context, offset);
