...
class _AllDayAppointmentRenderObject extends CustomCalendarRenderObject {
  ...
  ValueNotifier<AllDayPanelSelectionDetails?> get selectionNotifier => _selectionNotifier;
  ...
  void _drawAllDayAppointmentView(PaintingContext context, Offset offset, AppointmentView appointmentView) {
    ...
    final double iconTextSize = _getTextSize(rect, _textPainter.textScaler.scale(appointmentTextStyle.fontSize!));
    ...
    for (int i = 0; i < appointmentCollection.length; i++) {
      ...
      if (appointmentView.position == 0 && appointmentView.startIndex <= index && appointmentView.endIndex > index) {
        selectionDecoration ??= BoxDecoration(
          color:
              themeData.brightness == Brightness.light ? Colors.white.withOpacity(0.3) : Colors.black.withOpacity(0.4),
  ...
  void _updateSelectionDecorationPainter() {
    selectionNotifier.value =
        AllDayPanelSelectionDetails(selectionNotifier.value!.appointmentView, selectionNotifier.value!.selectedDate);
  }
