...
class AIAssistViewM2ThemeData extends SfAIAssistViewThemeData {
  ...
  @override
  Color? get actionButtonDisabledForegroundColor => _colorScheme.onSurface.withOpacity(0.38);

  @override
  Color? get actionButtonDisabledBackgroundColor => _colorScheme.surface.withOpacity(0.12);
  ...
  @override
  WidgetStateProperty<Color?> get suggestionItemBackgroundColor => WidgetStateProperty.resolveWith<Color?>(
  ...
  @override
  WidgetStateProperty<ShapeBorder?>? get suggestionItemShape => WidgetStateProperty.all<ShapeBorder?>(
  ...
  @override
  WidgetStateProperty<Color?> get responseToolbarItemBackgroundColor => WidgetStateProperty.resolveWith<Color?>(
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.hovered) || states.contains(WidgetState.focused)) {
  ...
  @override
  WidgetStateProperty<ShapeBorder?>? get responseToolbarItemShape => WidgetStateProperty.all<ShapeBorder?>(
        const RoundedRectangleBorder(
          borderRadius: BorderRadius.all(Radius.circular(20.0)),
        ),
      );
  ...
  @override
  WidgetStateProperty<TextStyle?>? get suggestionItemTextStyle => WidgetStateProperty.resolveWith<TextStyle?>(
        (Set<WidgetState> states) {
          if (states.contains(WidgetState.disabled)) {
            return TextStyle(
